...
public abstract class AbstractMenuButton {
    ...
    private static final String BUTTON_LOCATOR_PATTERN = "//div[@id='fade-menu']//a[text()='%s']";
    public static final String OPTION_LOCATOR_PATTERN = "//div[@id='fade-menu']//a[text()='%s']";
